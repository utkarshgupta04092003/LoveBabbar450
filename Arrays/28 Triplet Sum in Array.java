...
there's a triplet in the array which sums up to the given
integer X.
...
to complete the function find3Numbers() which takes the 
array arr[], the size of the array (n) and the sum (X) as 
inputs and returns True if there exists a triplet in the 
